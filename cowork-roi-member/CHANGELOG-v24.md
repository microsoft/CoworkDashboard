...
user. A teammate who dropped in the shared `cowork-roi-member/` folder and ran it got back *exactly*
...
analyzed→produced, deliverables, activity), the mandatory privacy opt-out, the fixed ROI Advisors
