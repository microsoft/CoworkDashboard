...
is mirrored in `cowork-roi-report`; the aggregated team-channel reader reuses
...
## Unchanged
The harvest, the mandatory privacy opt-out, the fixed team channel, the per-user owner-scoped
